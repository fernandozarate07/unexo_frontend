...
import Hero from "./sections/hero"; // Componente de la sección "Hero", probablemente contiene un encabezado o presentación destacada.
import HowWorks from "./sections/howWorks"; // Componente de la sección "How it Works", donde se explica el funcionamiento de la aplicación.
